...
-- A quick note on the ICON_ATLAS_RWB_VIAJANTELITURGICO atlas. I've left this in here, configured in this way, to illustrate how to use multi-icon atlases. In this example, each WerejaguarAtlasXXX.dds file has two icons - the Unique Unit icon and Unique Unit portrait. We'll describe further down how we differentiate to the game which should be used for which function through the IconDefinitions section.
...
VALUES	('ICON_ATLAS_RWB_NORTECHICO',					22,	 		1,				1,					'OlmecAtlas22.dds'			),
		...
		('ICON_ATLAS_RWB_VIAJANTELITURGICO',			22,			2,				1,					'WerejaguarAtlas22.dds'		),
		('ICON_ATLAS_RWB_VIAJANTELITURGICO',			32,			2,				1,					'WerejaguarAtlas32.dds'		),
		('ICON_ATLAS_RWB_VIAJANTELITURGICO',			38,			2,				1,					'WerejaguarAtlas38.dds'		),
		('ICON_ATLAS_RWB_VIAJANTELITURGICO',			50,			2,				1,					'WerejaguarAtlas50.dds'		),
		('ICON_ATLAS_RWB_VIAJANTELITURGICO',			70,			2,				1,					'WerejaguarAtlas70.dds'		),
		('ICON_ATLAS_RWB_VIAJANTELITURGICO',			80,			2,				1,					'WerejaguarAtlas80.dds'		),
		('ICON_ATLAS_RWB_VIAJANTELITURGICO',			95,			2,				1,					'WerejaguarAtlas95.dds'		),
		('ICON_ATLAS_RWB_VIAJANTELITURGICO',			200,		2,				1,					'WerejaguarAtlas200.dds'	),
		('ICON_ATLAS_RWB_VIAJANTELITURGICO',			256,		2,				1,					'WerejaguarAtlas256.dds'	),
...
VALUES	('ICON_CIVILIZATION_RWB_NORTECHICO',				'ICON_ATLAS_RWB_NORTECHICO',			0					),
		...
		('ICON_UNIT_RWB_VIAJANTELITURGICO_PORTRAIT',		'ICON_ATLAS_RWB_VIAJANTELITURGICO',		0					),
		('ICON_UNIT_RWB_VIAJANTELITURGICO',					'ICON_ATLAS_RWB_VIAJANTELITURGICO',		1					);