...
VALUES		('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	'LOC_CITY_NAME_RWB_NORTECHICO_1'	);
...
VALUES		('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_1'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_2'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_3'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_4'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_5'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_6'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_7'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_8'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_9'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_10'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_11'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_12'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_13'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_14'		),
			('CIVILIZATION_RWB_NORTECHICO',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_RWB_NORTECHICO_15'		);
