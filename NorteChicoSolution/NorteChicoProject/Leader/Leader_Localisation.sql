...
-----------------------------------------------	
	...
	('en_US',	'LOC_DIPLO_WARNING_LEADER_RWB_LADY_OF_THE_FOUR_TUPUS_REASON_ANY',	'(You are militarily inclined and have a large military force.)'	),
	('en_US',	'LOC_DIPLO_MODIFIER_RWB_LADY_OF_THE_FOUR_TUPUS_UNHAPPY',	'me angery'	),
...
--------------------------------------------------------------------
	...
	('en_US',	'LOC_PEDIA_UNITS_PAGE_UNIT_RWB_LADY_OF_THE_FOUR_TUPUS_UU_CHAPTER_HISTORY_PARA_1',  	
